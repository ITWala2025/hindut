    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0"
          ...
          <!-- Header - Red/Error theme -->
          <tr>
            <td style="background:linear-gradient(135deg,#dc2626,#b91c1c);padding:28px 40px 24px;text-align:center;">
          ...
          <tr>
            <td style="padding:36px 40px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding:20px 24px;">
                          <p style="margin:0 0 4px;font-size:12px;text-transform:uppercase;
                                     letter-spacing:1px;color:#991b1b;font-family:Arial,sans-serif;">
                            ⚠️ Payment Failed
                          </p>
                ...
                <tr>
                  <td style="padding:0 0 24px;">
                    <p style="margin:0 0 12px;font-size:13px;color:#78716c;text-transform:uppercase;
                               letter-spacing:1px;font-family:Arial,sans-serif;">
                      Transaction Details
                    </p>
                    <table width="100%" cellpadding="0" cellspacing="0"
                           style="background:#fafaf9;border-radius:6px;border:1px solid #e7e5e4;">
                      <tr>
                        <td style="padding:12px 16px;border-bottom:1px solid #e7e5e4;">
                          <span style="font-size:12px;color:#78716c;text-transform:uppercase;
                                       letter-spacing:1px;font-family:Arial,sans-serif;">Item</span>
                          &nbsp; <span style="font-size:14px;color:#1c1917;font-family:Arial,sans-serif;">
                            ${p.itemName}
                          </span>
                        </td>
                ...
                <tr>
                  <td style="padding:0 0 24px;">
                    <p style="margin:0 0 12px;font-size:13px;font-weight:700;color:#1c1917;
                               font-family:Arial,sans-serif;">
                      What can you do?
                    </p>
                    <ul style="margin:0;padding:0 0 0 20px;font-size:14px;color:#44403c;
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                      ...
                      <tr>
                        <td style="padding:16px 20px;">
                          <p style="margin:0;font-size:14px;color:#6b21a8;font-family:Arial,sans-serif;
                                     line-height:1.6;">
                ...
                <tr>
                  <td style="padding:20px 0 0;border-top:1px solid #e7e5e4;padding-top:20px;">
                    <p style="margin:0;font-size:14px;color:#44403c;font-family:Arial,sans-serif;
                      ...
                      contact us at
                      <a href="mailto:info@hindutemple.ie"
                         style="color:#7c3aed;text-decoration:none;">info@hindutemple.ie</a>
                    </p>
                  </td>
                </tr>
